...
import com.dlwx.onedrop.adapter.TiXianRecordAdapter;
...
public class TiXianRecordActivity extends BaseActivity {
    ...
    protected void initData() {
        initTabBar(toolBar);
        tvTitle.setText(R.string.tixian);
    ...
    public void showData(String s) {
        ...
        if (myCommissBean.getCode() == 200) {
            ...
            if (myCommissBean.getBody() != null) {
                ...
                TiXianRecordAdapter adapter = new TiXianRecordAdapter(ctx, body);
